    ...
    <div className="codeblock relative w-full bg-zinc-950 font-sans shadow-lg">
      <div className="flex w-full items-center justify-between bg-zinc-800 px-6 py-2 pr-4 text-zinc-50">
        ...
        <div className="flex space-x-2">
          <button onClick={downloadFile} className="w-5 h-5 hover:text-gray-300 text-gray-500 absolute top-1 right-8 transition-all button-transparent duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
            </svg>
          </button>
          <button onClick={copyToClipboard} className="w-5 h-5 hover:text-gray-300 text-gray-500 absolute right-1 top-1 transition-all duration-200 button-transparent">
            {copySuccess ? (
